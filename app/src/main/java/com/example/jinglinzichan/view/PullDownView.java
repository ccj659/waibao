...
import com.example.jinglinzichan.view.ScrollOverListView.OnScrollOverListener;
...
public class PullDownView extends LinearLayout implements OnScrollOverListener {
	...
	public void enableAutoFetchMore(boolean enable, int index) {
		if (enable) {
			...
			mFooterTextView.setText("正在获取..");
			mFooterTextView.setTextColor(0xffd4d8dc);
