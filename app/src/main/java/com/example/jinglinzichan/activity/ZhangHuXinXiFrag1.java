...
public class ZhangHuXinXiFrag1 extends Fragment implements OnClickListener,
		BusinessResponse {
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		tab1view=inflater.inflate(R.layout.zhanghuxinxi, container, false);
		return tab1view;	
	...
	public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
		...
		// 确认
		sousuo_layout = (LinearLayout) tab1view.findViewById(R.id.sousuo_layout);
		...
		// 昵称
		nicheng = (TextView) tab1view.findViewById(R.id.nicheng);
		// Email
		email = (EditText) tab1view.findViewById(R.id.email);
		// 真实姓名
		zhenshixingming = (TextView) tab1view.findViewById(R.id.zhenshixingming);
		// 身份证号
		shenfenzhenghao = (TextView) tab1view.findViewById(R.id.shenfenzhenghao);
		// 手机号码
		shoujihao = (TextView) tab1view.findViewById(R.id.shoujihao);
		// 性 别
		RadioGroup = (RadioGroup) tab1view.findViewById(R.id.RadioGroup);
		// 给RadioGroup设置事件监听
		RadioGroup
		...
		// 男
		rb_nan = (RadioButton) tab1view.findViewById(R.id.rb_nan);
		// 女
		rb_nv = (RadioButton) tab1view.findViewById(R.id.rb_nv);
		// 所在省
		sheng_Layout = (LinearLayout) tab1view.findViewById(R.id.sheng_Layout);
		sheng_Layout.setOnClickListener(this);
		sheng_text = (TextView) tab1view.findViewById(R.id.sheng_text);
		// 所在市
		shi_Layout = (LinearLayout) tab1view.findViewById(R.id.shi_Layout);
		shi_Layout.setOnClickListener(this);
		shi_text = (TextView) tab1view.findViewById(R.id.shi_text);
		// 居住地址
		juzhudizhi = (EditText) tab1view.findViewById(R.id.juzhudizhi);
		// 邀请码
		yaoqingma = (EditText) tab1view.findViewById(R.id.yaoqingma);
		yaoqingma.setFocusable(false);
		tupian_yaoqingma = (ImageView) tab1view.findViewById(R.id.tupian_yaoqingma);
	...
	public void showPopupWindow(View parent) {
		// 加载布局
		LinearLayout view = (LinearLayout) LayoutInflater.from(getActivity()).inflate(
		...
		adaptera = new ZhangHuXinXiAdapter(getActivity(), data);
		sheng_lv.setAdapter(adaptera);

		shi_lv = (ListView) view.findViewById(R.id.shi_lv);
		adapterb = new ZhangHuXinXiAdapter(getActivity(), dataa);
